# Architectural core semantic signal plan

This directory applies the same artifact filter to the heuristic symbol-reference graph. It is the cleanest currently available approximation to a semantic architectural core.
